...
import 'features/pokedex/data/adapter/list_pokemon_adapter.dart' as _i15;
...
import 'features/pokedex/data/datasources/remote/list_pokemon_ds_remote.dart'
    as _i13;
import 'features/pokedex/domain/ports/list_pokemon_port.dart' as _i14;
import 'features/pokedex/domain/usecases/list_pokemon_usecase.dart' as _i16;
import 'features/pokedex/presentation/bloc/list_pokemon_cubit.dart' as _i18;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i8.ListPokemonDataSourceLocal>(
      () => _i9.ListPokemonDataSourceLocalHive(),
      registerFor: {_hive});
  gh.lazySingleton<_i8.ListPokemonDataSourceLocal>(
      () => _i10.ListPokemonDataSourceLocalMemory(),
      registerFor: {_memory});
  gh.lazySingleton<_i8.ListPokemonDataSourceLocal>(
      () => _i11.ListPokemonDataSourceLocalMoor(),
      registerFor: {_moor});
  gh.lazySingleton<_i8.ListPokemonDataSourceLocal>(
      () => _i12.ListPokemonDataSourceLocalSqlite(),
      registerFor: {_sqlite});
  gh.lazySingleton<_i13.ListPokemonDataSourceRemote>(
      () => _i13.ListPokemonDataSourceRemoteImpl());
  gh.lazySingleton<_i14.ListPokemonPort>(() => _i15.ListPokemonAdapter(
      get<_i8.ListPokemonDataSourceLocal>(),
      get<_i13.ListPokemonDataSourceRemote>(),
      get<_i3.CachePokemonDataSourceRemote>()));
  gh.lazySingleton<_i16.ListPokemonUsecase>(
      () => _i16.ListPokemonUseCaseImpl(get<_i14.ListPokemonPort>()));
  gh.lazySingleton<_i17.DetailPokemonCubit>(
      () => _i17.DetailPokemonCubit(get<_i7.DetailPokemonUsecase>()));
  gh.lazySingleton<_i18.ListPokemonCubit>(
      () => _i18.ListPokemonCubit(get<_i16.ListPokemonUsecase>()));
  return get;
}
